...
class Messages:
	...
	def msg1(self):
		self.msgBox(cfg.QtWidgetsSCP.QApplication.translate("semiautomaticclassificationplugin", "Information") + " [1]", cfg.QtWidgetsSCP.QApplication.translate("semiautomaticclassificationplugin", "Default ROI style"))
	...
	def msg7(self):	
		self.msgBox(cfg.QtWidgetsSCP.QApplication.translate("semiautomaticclassificationplugin", "Information") + " [7]", cfg.QtWidgetsSCP.QApplication.translate("semiautomaticclassificationplugin", "No file found"))
	...
	def msg12(self):
		self.msgBar(cfg.QtWidgetsSCP.QApplication.translate("semiautomaticclassificationplugin", "Information") + " [12]", cfg.QtWidgetsSCP.QApplication.translate("semiautomaticclassificationplugin", "Select a classification output"))
	...
	def msg15(self):
		self.msgBar(cfg.QtWidgetsSCP.QApplication.translate("semiautomaticclassificationplugin", "Information") + " [15]", cfg.QtWidgetsSCP.QApplication.translate("semiautomaticclassificationplugin", "Restart QGIS for the new settings"))
	...
	""" Errors """
	def msgErr1(self):
		self.msgBarError(cfg.QtWidgetsSCP.QApplication.translate("semiautomaticclassificationplugin", "Error") + " [1]", cfg.QtWidgetsSCP.QApplication.translate("semiautomaticclassificationplugin", "Classification failed."))
	...
	#def msgErr3(self):
		#self.msgBarError(cfg.QtWidgetsSCP.QApplication.translate("semiautomaticclassificationplugin", "Error") + " [3]", cfg.QtWidgetsSCP.QApplication.translate("semiautomaticclassificationplugin", "Signature calculation failed."))
	...
	def msgErr10(self):
		self.msgBarError(cfg.QtWidgetsSCP.QApplication.translate("semiautomaticclassificationplugin", "Error") + " [10]", cfg.QtWidgetsSCP.QApplication.translate("semiautomaticclassificationplugin", "Raster not found or clip failed"))
		
	def msgErr11(self):
		self.msgBarError(cfg.QtWidgetsSCP.QApplication.translate("semiautomaticclassificationplugin", "Error") + " [11]", cfg.QtWidgetsSCP.QApplication.translate("semiautomaticclassificationplugin", "Shapefile or raster not found"))
		
	def msgErr12(self):
		self.msgBarError(cfg.QtWidgetsSCP.QApplication.translate("semiautomaticclassificationplugin", "Error") + " [12]", cfg.QtWidgetsSCP.QApplication.translate("semiautomaticclassificationplugin", "Error deleting ROI"))
		
	def msgErr13(self):
		self.msgBarError(cfg.QtWidgetsSCP.QApplication.translate("semiautomaticclassificationplugin", "Error") + " [13]", cfg.QtWidgetsSCP.QApplication.translate("semiautomaticclassificationplugin", "The Macroclass field is missing"))
	...
	def msgErr22(self):
		self.msgBarError(cfg.QtWidgetsSCP.QApplication.translate("semiautomaticclassificationplugin", "Error") + " [22]", cfg.QtWidgetsSCP.QApplication.translate("semiautomaticclassificationplugin", "Exporting Log file failed"))

	def msgErr23(self):
		self.msgBarError(cfg.QtWidgetsSCP.QApplication.translate("semiautomaticclassificationplugin", "Error") + " [23]", cfg.QtWidgetsSCP.QApplication.translate("semiautomaticclassificationplugin", "Saving algorithm files failed"))

	def msgErr23(self):
		self.msgBarError(cfg.QtWidgetsSCP.QApplication.translate("semiautomaticclassificationplugin", "Error") + " [23]", cfg.QtWidgetsSCP.QApplication.translate("semiautomaticclassificationplugin", "Unable to get ROI attributes; check training shapefiles field names"))
	...
	def msgErr29(self):
		self.msgBarError(cfg.QtWidgetsSCP.QApplication.translate("semiautomaticclassificationplugin", "Error") + " [29]", cfg.QtWidgetsSCP.QApplication.translate("semiautomaticclassificationplugin", "Edge error. Reduce the ROI width or draw a ROI manually (recommended installation of GDAL >= 1.10)"))
		
	def msgErr30(self):
		self.msgBarError(cfg.QtWidgetsSCP.QApplication.translate("semiautomaticclassificationplugin", "Error") + " [30]", cfg.QtWidgetsSCP.QApplication.translate("semiautomaticclassificationplugin", "Unable to proceed. Rename the Landsat bands with a file name ending with the band number (e.g. rename B20 to B2)"))
	...
	def msgErr49(self):
		self.msgBarError(cfg.QtWidgetsSCP.QApplication.translate("semiautomaticclassificationplugin", "Error") + " [49]", cfg.QtWidgetsSCP.QApplication.translate("semiautomaticclassificationplugin", "Unable to connect. Check user name and password"))
	...
	def msgErr51(self):
		self.msgBarError(cfg.QtWidgetsSCP.QApplication.translate("semiautomaticclassificationplugin", "Error") + " [51]", cfg.QtWidgetsSCP.QApplication.translate("semiautomaticclassificationplugin", "No metadata found inside the input directory (a .xml file whose name contains MTD_L1C)"))
		
	def msgErr52(self):
		self.msgBarError(cfg.QtWidgetsSCP.QApplication.translate("semiautomaticclassificationplugin", "Error") + " [52]", cfg.QtWidgetsSCP.QApplication.translate("semiautomaticclassificationplugin", "No metadata found inside the input directory (a .xml file whose name contains MTD_SAFL1C)"))
	...
	def msgWar2Linux(self):
		self.msgBoxWarning(cfg.QtWidgetsSCP.QApplication.translate("semiautomaticclassificationplugin", "Warning") + " [2]", cfg.QtWidgetsSCP.QApplication.translate("semiautomaticclassificationplugin", "It appears that SciPy is not correctly installed. Please, see this page for information about SciPy installation ") + " http://semiautomaticclassificationmanual-v4.readthedocs.org/en/latest/installation_ubuntu.html#qgis-download-and-installation ")
		
	def msgWar5(self):
		self.msgBarWarning(cfg.QtWidgetsSCP.QApplication.translate("semiautomaticclassificationplugin", "Warning") + " [5]", cfg.QtWidgetsSCP.QApplication.translate("semiautomaticclassificationplugin", "rasters have different pixel sizes that can lead to incorrect results. Please, consider to resample rasters to the same pixel size"))

	def msgWar6(self):
		self.msgBarWarning(cfg.QtWidgetsSCP.QApplication.translate("semiautomaticclassificationplugin", "Warning") + " [6]", cfg.QtWidgetsSCP.QApplication.translate("semiautomaticclassificationplugin", "The same ID class has been already assigned to a different macrolass"))
	...
	def msgWar15(self):
		self.msgBarWarning(cfg.QtWidgetsSCP.QApplication.translate("semiautomaticclassificationplugin", "Warning") + " [15]", cfg.QtWidgetsSCP.QApplication.translate("semiautomaticclassificationplugin", "Select at least one raster"))
